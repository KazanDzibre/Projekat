...
namespace ServerApp
{
    class ThreadFunctions
    {
        ...
        public static List<SwitchOutput> switchOutList = new List<SwitchOutput>();

        public static SwitchOutput Switch_on = new SwitchOutput();

        public static SwitchOutput Switch_off = new SwitchOutput();
